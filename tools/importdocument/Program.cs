...
/// <summary>
/// This console app imports a list of files to Q-Pilot's WebAPI document memory store.
/// </summary>
public static class Program
{
    public static void Main(string[] args)
    {
        ...
        var rootCommand = new RootCommand(
            "This console app imports files to Q-Pilot's WebAPI document memory store."
        )
        {
            filesOption,
